...
export const OnScreenKeyboard: React.FC<OnScreenKeyboardProps> = ({ onKeyPress, language = 'en-CA' }) => {
  const regularKeys = [
    ['q', 'w', 'e', 'r', 't', 'y', 'u', 'i', 'o', 'p'],
    ['a', 's', 'd', 'f', 'g', 'h', 'j', 'k', 'l'],
    ['z', 'x', 'c', 'v', 'b', 'n', 'm']
  ];
  const frenchKeys = ['é', 'è', 'ê', 'ë', 'à', 'â', 'ù', 'û', 'î', 'ï', 'ô', 'ç'];
  ...
  const baseKeyStyles = "bg-white rounded-lg shadow px-4 py-2 text-lg hover:bg-gray-50";
